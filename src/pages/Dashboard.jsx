    ...
    <>
      ...
      >
          ...
          <div className="flex gap-6 text-right">
            ...
            <div>
              <Motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-neon-gold font-bold text-xl"
              >
                {tokensDisplay}
              </Motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Motion.div
            variants={itemVariants}
            className="hidden md:block md:col-span-2 md:col-start-2 md:row-start-2"
          >
            <div
              ref={boxRef}
              className="relative w-full h-56 bg-black overflow-hidden"
            >
              <canvas
                ref={canvasRef}
